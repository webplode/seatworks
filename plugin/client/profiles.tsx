...
export function ProfilesSection({ catalog, values, theme, disabled, save }: { catalog: Catalog; values: Layer; theme: PluginTheme; disabled: boolean; save(change: (values: Layer) => Layer): Promise<boolean> }) {
  ...
  return <View style={{ gap: 12 }}>
    ...
    <Text style={{ color: theme.colors.foregroundMuted }}>Seatworks starts the rest of the team for you. Hiding a shortcut only removes it from the picker; Seatworks still uses the profile to give each agent its role and tools.</Text>
